...
@Component({
  selector: 'app-cons-vins-rouges',
  templateUrl: './cons-vins-rouges.component.html',
  styleUrls: ['./cons-vins-rouges.component.css']
})
export class ConsVinsRougesComponent implements OnInit {
  ...
  liste: any;
  ngOnInit(): void {
    this.getAllProduitBySousCategorie('Vins rouges');
  }
