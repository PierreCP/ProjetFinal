...
@Component({
  selector: 'app-cons-legumes-choux',
  templateUrl: './cons-legumes-choux.component.html',
  styleUrls: ['./cons-legumes-choux.component.css']
})
export class ConsLegumesChouxComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.getAllProduitBySousCategorie('Choux');
  }
