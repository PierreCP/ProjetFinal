...
@Component({
  selector: 'app-cons-bieres-brunes',
  templateUrl: './cons-bieres-brunes.component.html',
  styleUrls: ['./cons-bieres-brunes.component.css']
})
export class ConsBieresBrunesComponent implements OnInit {
