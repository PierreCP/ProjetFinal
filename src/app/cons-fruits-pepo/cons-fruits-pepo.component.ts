...
@Component({
  selector: 'app-cons-fruits-pepo',
  templateUrl: './cons-fruits-pepo.component.html',
  styleUrls: ['./cons-fruits-pepo.component.css']
})
export class ConsFruitsPepoComponent implements OnInit {
