...
const routes: Routes = [
  ...
  {component: HistoriqueCommandeComponent, path: 'historique-com'},
  {component: NouvellesCommandesComponent, path: 'nouvelles-com'},
  ...
  {component: CommandesPersoComponent, path: 'commandes-perso'}
